...
const calc_ab = document.getElementById("calc_aba")
const calc_a = document.getElementById("calc")
...
calc_ab.addEventListener("click", (el)=>{
    calc_a.classList.toggle("calc_exibir")
    if(calc_a.classList.contains("calc_exibir")){
        img.setAttribute("src", "outline_chevron_left_black_24dp.png")
    }else{
        img.setAttribute("src", "outline_navigate_next_black_24dp.png")
    }
})